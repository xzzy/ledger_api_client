...
class LedgerDBRouter(object):
    ...
    def db_for_read(self, model, **hints):
        ...
        if (
            ...
            or model._meta.db_table == "accounts_address"
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if (
            "accounts_emailuser" == obj1._meta.db_table
            and "ledger_api_client_systemuser" == obj2._meta.db_table
        ):
            return True
...
class EmailUserRO(AbstractBaseUser, PermissionsMixinRO):
    ...
    postal_same_as_residential = models.BooleanField(
        default=False, null=True, blank=True
    )
    billing_address = models.ForeignKey(
        Address, null=True, blank=True, related_name="+", on_delete=models.DO_NOTHING
    )
    billing_same_as_residential = models.BooleanField(
        default=False, null=True, blank=True
    )
